...
| `chain.counter` (ADR 0005, A3) | chain | owner-signed, provider-acked | permanent | listable | chain-linked / SHA-256 | rolling (checkpoint + ack-before-shred — compaction lands A4) |
